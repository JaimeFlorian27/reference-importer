...
class Ui_Test(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_output.addWidget(self.lineEdit_output_directory, 1, 0, 1, 3)

        self.checkBox_imagePlane = QCheckBox(self.groupBox_output)
        self.checkBox_imagePlane.setObjectName(u"checkBox_imagePlane")

        self.gridLayout_output.addWidget(self.checkBox_imagePlane, 2, 2, 1, 2)
        ...
        self.gridLayout_output.addWidget(self.label_output_directory, 0, 0, 1, 1)
        ...
        self.gridLayout_output.addWidget(self.pushButton_fileExplorer_output, 1, 3, 1, 1)
        ...
        self.gridLayout_output.addWidget(self.label_frameRate, 2, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_fileExplorer_input.setText(QCoreApplication.translate("Dialog", u"PushButton", None))
        ...
        self.pushButton_fileExplorer_output.setText(QCoreApplication.translate("Dialog", u"PushButton", None))
