...
class ImageSequencer():
    ...
    def __init__(self, video_file="",output_name="", padding = "%03d" ,output_frameRate= 24):
        ...
        self.ffmpeg_path = u'C:\\Users\\Usuario\\OneDrive\\Escritorio\\Arte\\Programación\\Maya\\scripts\\imageSequence\\ReferenceImporter\\lib\\ffmpeg\\ffmpeg'
        print(type(self.ffmpeg_path))
